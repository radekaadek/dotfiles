...
# set CXX to clang++ to use clang as the default compiler
export CC=clang
export CXX=clang++

export CGAL_DIR=/home/ard/prg/cgals/cgal
export CGAL_DATA_DIR=$CGAL_DIR/Data/data

export PATH="/home/ard/.spicetify:$PATH"
export PATH="/home/ard/development/flutter/bin:$PATH"

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/ard/anaconda3/bin/conda' 'shell.zsh' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/ard/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/ard/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/ard/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
